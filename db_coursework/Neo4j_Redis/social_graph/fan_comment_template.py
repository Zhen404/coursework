...
class FanGraph(object):
    ...
    def create_comment(self, uni, comment, team_id=None, player_id=None):
        ...
        """
        if uni is None or comment is None or \
            (team_id is None and player_id is None):
        ...
        try:
            ...
            new_c = Node("Comment", comment=comment, \
    ...
    def create_sub_comment(self, uni, origin_comment_id, comment):
        ...
        """
        if uni is None or origin_comment_id is None or \
                    comment is None:
            raise ValueError("Bad Input")
        ...
        try:
            ...
            if f is None or old_c is None:
                raise ValueError("Fan or comment not found")
    ...
    def get_team_comments(self, team_id):
        ...
        :return: Graph containing comment, comment streams and commenters.
        """
        q = 'match (fan)-[by:COMMENT_BY]->(comment)-[on:COMMENT_ON]->(team:Team {team_id:{tid}}) ' + \
